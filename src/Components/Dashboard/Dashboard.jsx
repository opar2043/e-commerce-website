        ...
        <div className="space-y-2">
          ...
          <ul className="space-y-1">
            <li>
              <Link
                to="/dashboard/admin"
                className="flex items-center gap-3 text-gray-700 hover:bg-[#D99B55] hover:text-white rounded-lg px-4 py-3 transition-all duration-200"
              >
        ...
        <div className="pt-8 mt-8 border-t border-gray-200">
          <ul className="space-y-2">
            <li>
              <Link
                to="/"
                className="flex items-center gap-3 bg-[#D99B55] text-white hover:bg-red-500 rounded px-4 py-3 transition-all duration-200"
              >
